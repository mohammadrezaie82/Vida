<template>
  <div class="relative min-h-screen overflow-hidden">
    <div
      class="absolute inset-0 -z-10 bg-gradient-to-br dark:from-cyan-900 dark:via-slate-900 dark:to-slate-950 from-white via-cyan-50 to-blue-50"
    ></div>
    <div
    ...
    <div class="absolute top-6 left-6 z-20">
      <v-btn
        icon
        @click="toggleTheme"
        class="rounded-full p-2 bg-white/20 dark:bg-gray-900/20 shadow-lg hover:bg-white/30 dark:hover:bg-gray-800/30 transition"
      >
    ...
    <div class="flex flex-col-reverse lg:flex-row min-h-screen">
      <div
        class="flex items-center justify-center p-4 sm:p-6 lg:p-8 w-full lg:w-1/2"
      >
        <div
        ...
        >
          ...
          <h1 class="text-2xl md:text-3xl font-semibold leading-8 mb-2">
            {{ t("title") }}
          </h1>
          <p
            class="text-sm md:text-base text-slate-700 dark:text-slate-300 mb-6"
          >
            {{ t("subtitle") }}
          </p>
      ...
      <div
        class="flex flex-col justify-center p-4 sm:p-6 lg:p-12 w-full lg:w-1/2 text-slate-900 dark:text-white mt-28 lg:mt-0"
      >
        <div
        ...
        >
          ...
          <div class="mt-8 flex flex-col gap-4">
            <div class="flex items-start gap-3">
              <div
                class="w-10 h-10 bg-white/30 dark:bg-white/20 rounded-full flex items-center justify-center"
              >
            ...
            <div class="flex items-start gap-3 justify-end">
              <div
                class="bg-cyan-400/90 dark:bg-cyan-500/90 text-white p-3 rounded-2xl rounded-tr-none shadow-md max-w-full"
              >
...
type Locale = "fa" | "en";
const currentLanguage = ref<Locale>(locale.value as Locale);
const currentLanguageLabel = computed(() =>
  currentLanguage.value === "fa" ? "فارسی" : "English",
);
